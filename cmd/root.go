...
func init() {
	...
	rootCmd.PersistentFlags().IntVar(&options.KernPerfEventMapPageNum, "first-packet-event-map-page-num", 32, "pageNum of eBPF map size for first packet events buffer")
